...
class Group_loan extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('super_admin/Group_Loan_model', 'group_loan_model');
    ...
    public function fetched_center_member_data()
    {
        ...
        $this->load->view('super_admin/group_loan/fetched_group_member_data', $data);
        ...
        if ($this->form_validation->run()) {
            ...
            for ($i = 1; $i <= $tenure; $i++) {
                ...
                if ($i > 1) {
                    ...
                    if ($tenure_type == 1) {
                        $rept_we_dt = 7 * $i - 7;
                        $Payment_start_date = date("Y-m-d", strtotime($Payment_start_dates . $rept_we_dt . 'day'));
                    } else if ($tenure_type == 2) {
                        $rept_bWe_dt = 14 * $i - 14;
                        $Payment_start_date = date("Y-m-d", strtotime($Payment_start_dates . $rept_bWe_dt . 'day'));
                    }
    ...
    public function fetched_loan_disbursment_data()
    {
        ...
        $data['group_details'] = $this->group_loan_model->get_group_details($val['group_id']);
        $this->load->view('super_admin/group_loan/fetched_loan_disbursment_data', $data);
    ...
    public function view_group_loan_details() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/view_group_loan_details', $data);
    ...
    public function update_group_loan_details() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/update_group_loan_details', $data);
    ...
    public function update_group_loan_data() {
        ...
        if($this->form_validation->run() == TRUE) {
            ...
            $updt = array(
                ...
                'loan_start_date'    => config_item('work_end'),
                'processing_fee'     => $loan['processing_fee'],
                'disbursment_status' => $loan['disbursement_status'],
    ...
    public function pay_group_loan_emi() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/pay_group_loan_emi', $data);
    ...
    public function view_group_loan_paid_emis() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/view_group_loan_paid_emi', $data);
    ...
    public function group_loan_paid_emi_print_bill() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/group_loan_paid_emi_print_bill', $data);
    ...
    public function refresh_disbursmnet_data() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/refresh_disburshment', $data);
    ...
    public function refresh_paid_emi_data() {
        ...
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('super_admin/group_loan/refresh_paid_emi', $data);
