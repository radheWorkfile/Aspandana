...
<span id="minBtnActn">super_admin/master/group/cStatus</span>
</div>
    
     <input type="hidden" id="locTrgt" value="super_admin/master/group/cStatus">
    <div class="card-body">
       ...
       <div class="row" id="vCreateNew" style="display:none;">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input class="form-control miCln" type="text" name="group_name" id="group_name" placeholder="Enter Group Name"maxlength="10"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');">
                </div>
            </div>
            <div class="col-md-4"> 
               <div class="mb-3">
                <label class="form-label">Center Name<span class="text-danger">*</span></label>
                <select class="form-control miCln" id="centerID" name="centerID">
