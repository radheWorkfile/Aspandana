            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="group_name" id="group_name" placeholder="Auto Generate">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="center_name" id="center_name" placeholder="Enter Center Name"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');"maxlength="10">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="address" id="address" row="2" placeholder="Enter Full Address Here!"maxlength="80"oninput="this.value = this.value.toLowerCase().replace(/[^a-z0-9,. ]/g, '').replace(/\s+/g, ' ');"
                        ></textarea>
                    </div>
                </div>
            </div>
