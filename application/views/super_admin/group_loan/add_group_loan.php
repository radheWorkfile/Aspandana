        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" name="amount" id="amount" placeholder="Enter Amount" maxlength="10" ="this.value = this.value.toUpperCase().replace(/[^0-9]/g, '').replace(/(\  *?)\  */g, '$1')">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="mb-3">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" id="work_end" value="<?php echo config_item('work_end');?>">
