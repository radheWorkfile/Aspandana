        ...
        printTable: function(search_data) {
            $("#dayEnd").DataTable({
                ...
                "ajax": {
                    ...
                    "type": "POST",
                    "url": base_url + 'super_admin/Day_end/manage_day_end',
                    "dataSrc": "data",
                    "data": search_data
...
function update_is_od(id) {
    $.ajax({
        type: "POST",
        url: base_url + 'super_admin/day_end/update_is_od',
        data: {
            'id': id
        },
...
function update_recovery_conformation(id) {
    $.ajax({
        url: base_url + 'super_admin/Day_end/recovery_posting_conformation',
        type: "POST",
        data: {
            'id': id
        },
...
$('#recovery_conformation_updata').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'super_admin/Day_end/update_recovery_posting_data',
        type: "POST",
...
function remove_od(id) {
    $.ajax({
        url: base_url + 'super_admin/Day_end/remove_od',
        type: "POST",
        data: {
            'id': id
        },
...
$('#remove_od_updata').submit(function(e) {
    e.preventDefault();
    $.ajax({
        url: base_url + 'super_admin/Day_end/remove_od_data',
        type: "POST",
        data: new FormData(this),
        processData: false,
        contentType: false,
